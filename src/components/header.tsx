          ...
          {user && (
            <nav className="flex items-center gap-4">
              <Link href="/candidates">
                <Button variant="ghost" className="text-blue-600 hover:text-blue-700 hover:bg-blue-50">求職者</Button>
              </Link>
              <Link href="/companies">
                <Button variant="ghost" className="text-green-600 hover:text-green-700 hover:bg-green-50">企業</Button>
              </Link>
              <Link href="/stores">
                <Button variant="ghost" className="text-orange-600 hover:text-orange-700 hover:bg-orange-50">店舗</Button>
              </Link>
              <Link href="/jobs">
